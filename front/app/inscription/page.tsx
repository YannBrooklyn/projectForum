...
import { ContentRegister } from "./component"
    ...
    return (
        <main className="flex justify-center items-center w-full">
            {!token ? (
                ...
                <ContentRegister textColor={generalTextColor} backgroundColorZoneText={backgroundColorZoneText} backgroundColorGeneralButton={backgroundColorGeneralButton} backgroundColorThird={backgroundColorThird} textColorGeneralButton={textColorGeneralButton}/>
            ) : null}
        </main>
    )
}
